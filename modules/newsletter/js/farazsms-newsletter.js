(function ($) {
  "use strict";
  const newsletter_send_ver_code = $("#newsletter_send_ver_code");
  const submit_div = $(".fsms_newsletter_submit");
  const submit_button = $("#fsms_newsletter_submit_button");
  const submit_code = $("#fsms_newsletter_submit_code");
  const resend_code = $("#fsms_newsletter_resend_code");
  const newsletter_completion_div = $("#fsms_newsletter_completion");
  const name = $("#fsms_newsletter_name");
  const mobile = $("#fsms_newsletter_mobile");
  const verify_code = $("#fsms_newsletter_verify_code");
  const newsletter_message = $("#fsms_newsletter_message");
