  ...
  const originalState = {
    inputs: {
      welcome_sms: {
        ...
        name: "welcome_sms",
        type: "checkbox",
        label: __("Send a welcome sms after sing up to the user?", "farazsms"),
      },
      welcome_sms_use_pattern: {
        ...
        type: "checkbox",
        label: __("Send welcome sms after sing up via pattern?", "farazsms"),
      ...
      welcome_sms_pattern: {
        ...
        type: "text",
        label: __("Welcome sms after sing up pattern code:", "farazsms"),
      ...
      welcome_sms_msg: {
        ...
        type: "textarea",
        label: __("Welcome message after sing up:", "farazsms"),
        infoTitle: __("Usable variables:", "farazsms"),
        infoBody: __("%display_name% and %username%", "farazsms"),
        isDependencyUsed: false,
      },
